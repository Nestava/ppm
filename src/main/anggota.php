...
<body>
    ...
    <div class="flex justify-center gap-3 my-5">
        <a href="anggota.php" class="border-2 px-3 py-1 rounded-md text-red-500 border-red-500 font-medium">Semua</a>
        <a href="?level=admin" class="border-2 px-3 py-1 rounded-md text-blue-500 border-blue-500 font-medium">Admin</a>
        <a href="?level=petugas" class="border-2 px-3 py-1 rounded-md text-green-500 border-green-500 font-medium">Petugas</a>
    </div>

    <?php if ($akunMentah['level'] == 'admin'): ?>
    <a href="register-admin.php" class="cursor-pointer">
        <div class="flex justify-end mx-9">
            <button class="border-2 rounded-2xl px-3 py-1 font-medium cursor-pointer border-black">+ Register Petugas</button>
        </div>
    </a>
    <?php endif; ?>
