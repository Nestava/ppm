        ...
        <form name="login" method="post" class="mb-3">
          <div class="mb-8">
            <div class="mb-3">
              ...
              <input id="username" name="username" class="mt-2 w-sm bg-gray-100 border-1 border-slate-300 rounded-lg px-1.5 py-1"
                placeholder="Masukkan Username" />
            </div>
            <div>
              <label for="password">Password</label><br />
              <input id="password" name="password" type="password" class="mt-2 w-sm bg-gray-100 border-1 border-slate-300 rounded-lg px-1.5 py-1"
                placeholder="Masukkan Password" />
            </div>
          </div>
          <button type="submit" value="Login" class="w-sm text-sm py-1.5 rounded-lg bg-red-700 text-white">LOGIN</button>
        </form>
