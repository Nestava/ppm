                ...
                <?php if (isset($_POST['hapus'])): ?>
                    <form method="post">
                        <button class="border-2 border-red-600 text-red-600 font-medium py-1 px-5 rounded-md cursor-pointer"
                            name="ya">Ya</button>
                        <button class="border-2 border-green-600 text-green-600 font-medium py-1 px-3 rounded-md cursor-pointer"
                            name="tidak">Tidak</button>
                    </form>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <form method="post">
                                <a href="../backend/hapus-anggota.php">
                                    <div class="flex justify-end">
                                        <button class="mt-14 bg-red-600 text-white py-2 px-4 rounded cursor-pointer"
                                            name="hapus" type="submit">Hapus
                                            Akun</button>
                                    </div>
                                </a>
                            </form>
