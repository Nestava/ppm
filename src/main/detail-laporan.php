        ...
        <div class="md:flex items-center justify-center">
            <div class="md:border md:border-slate-300 rounded-xl md:shadow px-5 pt-5 pb-10">
                ...
                <div class="mb-5">
                    ...
                    <div class="ml-3">
                        <div class="md:flex md:gap-1"><h2 class="font-medium">NIK: </h2> <?= $dataPelapor['nik'] ?></div>
                        <div class="md:flex md:gap-1"><h2 class="font-medium">Nama: </h2> <?= $dataPelapor['nama'] ?></div>
                        <div class="md:flex md:gap-1"><h2 class="font-medium">Username: </h2> <?= $dataPelapor['username'] ?></div>
                        <div class="md:flex md:gap-1"><h2 class="font-medium">No. Telepon: </h2> <?= $dataPelapor['telp'] ?></div>
                    </div>
                </div>
                <div class="mb-5">
