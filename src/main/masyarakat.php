...
<body>
    ...
    <div class="my-16 mx-30">
            ...
            <div class="bg-white shadow-md rounded-md overflow-hidden border border-gray-300">
                ...
                <label for="toggle-accordion" class="flex justify-between items-center px-4 py-5 cursor-pointer">
                    <div class="text-2xl">
                        ...
                        <span class="font-light text-gray-500 ml-2">(Harap dibaca sebelum mengisi laporan)</span>
                    </div>
                ...
                <div
                    ...
                    <ol class="text-gray-800 space-y-4 py-4 text-md list-decimal list-inside">
                        ...
                        <li class="border-t pt-4">
                            ...
                            Pelaporan yang sama secara berulang-ulang tanpa pembaruan informasi dianggap sebagai spam
        ...
        <div class="justify-items-center">
            <h1 class="text-3xl font-bold text-red-600">Alur Proses</h1>
            <div class="mt-5 flex items-center gap-5">
                ...
                <svg width="80px" height="80px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FF0000" stroke-width="2" stroke-linecap="round"
                ...
                <div class="justify-items-center">
                    ...
                    <svg width="70px" height="70px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="none">
